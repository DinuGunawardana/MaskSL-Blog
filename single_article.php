    ...
    <main role="main" class="bg-l py-4">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- Article -->
                <div class="content col-lg-9 p-0">
                    ...
                    <div class="post__content w-75 mx-auto">
                        ...
                        <div class="post-head text-center my-5 white">
                        ...
                        <div class="post-footer d-flex my-5">
                            ...
                            <div class="d-flex flex-column justify-content-around">
                                <h3 class="font-italic mb-1 ml-3 post__title"><?= $article['author_fullname'] ?></h3>
                                <p class="text-muted mb-1 ml-3"><?= $article['author_desc'] ?></p>
                                <div class="social_media ml-3">
                ...
                <div class="aside col-3">
                    <!-- Author Info -->
                    <div class="p-3 post__side">
                        <div class="d-flex align-items-center">
                            <img class="profile-thumbnail rounded-circle pr-3 ml-2" src="img/avatar/<?= $article['author_avatar'] ?>" alt="test avatar image" style="width: 60px;height: 60px;">
                            <h5 class="font-italic m-0 ml-2 text-white"><?= $article['author_fullname'] ?></h5>
                        </div>
                        <p class="author_desc p-1 text-light"><?= $article['author_desc'] ?></p>
                    ...
                    <div class="card my-3 post__side">
                        <div class="card-header"><strong> More from <?= $article['author_fullname'] ?></strong></div>

                        <ul class="list-group list-group-flush">
                            <?php foreach ($articles as $article) : ?>
                                <li class="list-group-item post__more"><a href="single_article.php?id=<?= $article['article_id'] ?>"><?= $article['article_title'] ?></a></li>
            ...
            <div id="comment" class="row">
                <div class="col-lg-9 p-4 mt-3 post__side">

                    <div class="comments">
                        <h2 class="text-center text-light py-3">Comments</h2>
